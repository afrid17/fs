...
import fishTotalItems from "@/data/items/fish/total_items";
import fishAllItems from "@/data/items/fish/allItems";
import fishBannerImages from "@/data/items/fish/bannerImages";
import fishMainItems from "@/data/items/fish/mainItems";
  ...
  return (
    <>
      <main>
        <div>
          <FishMenuStructure
            totalItems={fishTotalItems}
            allItems={fishAllItems}
            main_items={fishMainItems}
            banner_images={fishBannerImages}
...
function FishMenuStructure({
  ...
  return (
    <>
      <div>
        <div className="flex flex-col h-[50vh] bg-fishColor ">
          <div className=" pt-6">
            <div className="flex pl-4 pr-4   justify-between ">
              <div className=" flex space-x-4 items-center ">
                ...
                <div className="flex space-x-1 items-center">
                  <label className="text-xl font-bold  ">Fish</label>
                  <a
                    className="text-md "
                    onClick={() => {
                      dropItems
            ...
            {banner_images.map((item) => {
              return (
                <div key={item}>
                  <embed
                    src={item}
                    className=" w-[90vw] h-[4vh] object-cover rounded-md "
                  />
                </div>
              );
            })}
...
function NavMainItems({ selectedMainItem, main_items }) {
  ...
  return (
    <>
      <Slider
        {...settings}
        className="flex justify-center items-center text-center space-x-10 pt-8"
      >
          ...
          return (
            <div className=" w-[33vw] pl-4 " key={item[1]}>
              <div
                ...
                className="w-[28vw] flex flex-col items-center space-y-2 text-center"
              >
                <embed
                  src={item[0]}
                  className="object-fill h-[12vh] w-[12vh] rounded-full "
                />
                <label className="text-sm w-[31vw] text-center font-robotoMono">
                  {item[1]}
                </label>
              </div>
            </div>
